...
var scrolltotop={
	...
	controlHTML: '<img src="/img/pagetop.png" style="width:30px; height:100px" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
	...
	init:function(){
		jQuery(document).ready(function($){
			...
			mainobj.$control=$('<div id="topcontrol">'+mainobj.controlHTML+'</div>')
				.css({position:mainobj.cssfixedsupport? 'fixed' : 'absolute', bottom:/*mainobj.controlattrs.offsety*/200, right:/*mainobj.controlattrs.offsetx*/0, opacity:0, cursor:'pointer'})

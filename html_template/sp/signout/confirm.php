...
<div class="contents">
	...
	<p class="alncenter"><a href="/signout/?tkn=<?php echo getGet('tkn');?>" class="linkbtn4 alncenter">戻る</a> <a href="javascript:void(0);" onclick="document.frm.submit();" class="linkbtn alncenter">　　　退会する　　　</a></p>
</form>

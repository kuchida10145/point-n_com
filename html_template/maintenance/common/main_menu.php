<div id="sidebar-left" class="span2">
	...
	<ul class="nav nav-tabs nav-stacked main-menu">
		...
		<li><a href="news.php"><i class="icon-flag"></i><span class="hidden-tablet">お知らせ情報登録</span></a></li>
		...
		<li><a href="sp_coupon_edit.php"><i class="icon-bookmark"></i><span class="hidden-tablet">特別ポイント管理</span></a><li><a href="request_point.html"><i class="icon-edit"></i><span class="hidden-tablet">請求処理</span></a></li>

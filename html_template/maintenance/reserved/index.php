						...
						<table class="table table-striped table-bordered table-hover table-condensed">
							...
							<tbody>
								...
								<tr>
									...
									<td class="center"><?php echo $reserve_data['nickname'];?></td>
									...
									<?php if($reserve_data['status_id'] == "1"):?>
										<td class="center">
											<a class="btn btn-info" href="?m=index&update=<?php echo $reserve_data['reserved_id'];?>">受理</a>
											<a class="btn btn-danger" href="#" role="button" class="btn" data-toggle="modal" data-id="<?php echo $reserve_data['reserved_id'];?>">取消</a>
										</td>
									<?php else:?>
										<td class="center">&nbsp;</td>
									<?php endif;?>

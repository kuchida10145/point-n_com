...
// 合計メイン
$total_main = 	$list["use_n_point"] - $list["n_point"] - $list["n_point_commission"] 
			- $list["e_point"] - $list["e_point_commission"] - $list["sp_point"] 
			- $list["sp_point_commission"] + $list["use_e_point"] + $list["use_point"] 
...
// 合計キャンセル
$total_cancel = 	$list["n_point_cancel"] + $list["n_point_cancel_commission"] + $list["e_point_cancel"] 
					+ $list["e_point_cancel_commission"] - $list["use_n_point_cancel"] 
					- $list["use_e_point_cancel"] - $list["use_point_cancel"];

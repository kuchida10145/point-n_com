						...
						<div class="box-content">
							<form class="form-horizontal" action="?m=confirm&tkn=<?php echo getGet('tkn');?>" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<?php echo getParam($post, 'money').'円';?>
										<input type="hidden" value="<?php echo getParam($post, 'money');?>" name="money">
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<?php echo $appeal;?>
										<input type="hidden" value="<?php echo getParam($post, 'appeal');?>" name="appeal">
									</div>
								</div>

				...
				<div class="row-fluid">	
					<div class="box span12">
						<div class="box-content">
							...
							<div style="clear:both;">
								<div class="span8"></div>
								<div class="span4"><p style="font-size:16px;text-align:right;"><strong>ポイント利用 総合計　4,000PT</strong></p></div>
							</div>
							...
							<tr>
								...
								<td><?php echo getGet('coupon') == 1 ? $claim['use_point'] :$claim['get_point'] ;?>PT</td>
							</tr>
							<?php endforeach;?>
							</tbody>
							</table>

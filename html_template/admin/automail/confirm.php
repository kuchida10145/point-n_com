						...
						<form class="form-horizontal" action="?m=confirm&tkn=<?php echo getGet('tkn');?>" method="post">
                            ...
                            <div class="control-group">
							  <label class="control-label" for="typeahead">タイトル</label>
								<div class="controls">
									<?php echo getParam($post,'name');?>
								</div>
							</div>
                            
                            <div class="control-group">
								<label class="control-label" for="typeahead">件名</label>
								<div class="controls">
									<?php echo getParam($post,'subject');?>
								</div>
							</div>
                                                       
                            <div class="control-group">
								<label class="control-label" for="typeahead">送信元メールアドレス</label>
								<div class="controls">
									<?php echo getParam($post,'from_mail');?>
								</div>
							</div>
							
							<div class="control-group">
								<label class="control-label" for="typeahead">送信者名</label>
								<div class="controls">
									<?php echo getParam($post,'from_name');?>
								</div>
							</div>
							
							
							<div class="control-group">
								<label class="control-label" for="typeahead">エラー時の送信先メールアドレス</label>
								<div class="controls">
									<?php echo getParam($post,'return_path');?>
								</div>
							</div>
							
							<div class="control-group">
								<label class="control-label" for="typeahead">本文</label>
								<div class="controls">
									<?php echo str_replace("\r\n","<br />",getParam($post,'body'));?>
								</div>
							</div>

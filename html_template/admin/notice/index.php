		...
		<!-- end: Main Menu -->
			...
			<div id="content" class="span10">
							...
							<form class="form-horizontal" method="get">
								<div class="control-group">
									...
									<div class="controls">
										...
										※非公開にした場合、表示開始日や終了日に関係なく、POINT.COMのサイトから一時的にお知らせ情報が表示されなくなります。
									</div>
								</div>
								<div class="control-group">
									<label for="title" class="control-label">タイトル</label>
									<div class="controls">
										<input class="input-block-level" placeholder="" name="title" id="title" type="text" value="<?php echo getGet('title');?>">
									</div>
								</div>
								<div class="control-group">
				...
				<div class="row-fluid">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2><i class="halflings-icon align-justify"></i><span class="break"></span>POINT.COMからのお知らせ登録一覧</h2>
							<div class="box-icon">
								<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							</div>
						</div>
							...
							<table class="table table-striped table-bordered table-hover table-condensed">
								...
								<tbody>
									...
									<tr>
										...
										<td class="center"><?php echo $data['display_date'] == 0 ? '' : $data['display_date']; ?></td>
										<td><?php echo $data['title'];?></td>
										<td class="center"><?php echo $data['public_start_date'] == 0 ? '' : date_format(date_create($data['public_start_date']), 'Y/m/d');?></td>
										<td class="center"><?php echo $data['public_end_date'] == 0 ? '' : date_format(date_create($data['public_end_date']), 'Y/m/d');?></td>
										<td class="center">
											<a class="btn btn-info" href="?m=edit&id=<?php echo $data['notice_id'];?>"><i class="halflings-icon white edit"></i>編集</a>
											<a class="btn btn-danger" href="#myModal" role="button" class="btn" data-toggle="modal" data-id="<?php echo $data['notice_id'];?>"><i class="halflings-icon white trash"></i>削除</a>
										</td>
									</tr>
									<?php endforeach;?>
								</tbody>
